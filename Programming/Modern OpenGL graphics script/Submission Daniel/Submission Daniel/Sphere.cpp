...
void Sphere::updateModelMatrix(unsigned int modelViewMatLoc,float d, float scale)
{
...
void Sphere::Draw()
{
	int triCount = 660;
	glBindVertexArray(VAO);
	glDrawElementsInstanced(GL_TRIANGLE_STRIP, triCount, GL_UNSIGNED_INT, sphereIndices, 2);
}
